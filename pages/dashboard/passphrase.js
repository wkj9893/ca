...
export default function Dashboard() {
  ...
  const get_passphrase = (event) => {
    event.preventDefault();
    const passphrase = niceware.generatePassphrase(8).join(" ");
  ...
  return (
    <div className={classes.root}>
      ...
      <Container component="main" maxWidth="xs">
        ...
        <textarea id="w3review" name="w3review" rows="5" cols="50" defaultValue={passphrase}></textarea>
